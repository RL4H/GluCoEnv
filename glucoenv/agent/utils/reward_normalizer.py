# Disclaimer: This code is adpated from the openai phasic policy graient repo.
# Average reward calculations are integrated.
...
# reward = th.rand(10, 5)
# first = th.ones(10, 5) * 0
# r = RewardNormalizer(10, cliprew=10.0, gamma=0.99, epsilon=1e-8, per_env=True)
# reward = r(reward, first)
# print(reward.shape)