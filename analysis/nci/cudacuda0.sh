...
python3 /scratch/ny83/ch9972/pytorch-env/GluCoEnv/analysis/nci/ppo_example.py --env adolescent#001 --n_env 16 --d_env cuda:0 --d_agent cuda:0 --folder_id cudacuda0
wait
